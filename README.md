...
Although a `requirements.txt` file is not provided, based on the source code, the following software and libraries are required to run this project:
...
-   `models/`:
    -   (Not explicitly in codebase, but implied by `.env` configuration)
